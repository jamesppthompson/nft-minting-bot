  ...
  return (
    <div className="create-wallets">
      <div className='flex justify-between items-center'>
        <Typography variant="h5" gutterBottom component="div">Create Wallets</Typography>
      </div>
      <Typography variant="body2" gutterBottom component="div" mb={5}>Our bots are hosted on IPFS and run directly in YOUR browser, these details never leave your device.</Typography>
      <div className='mb-8'>
        ...
        <p className='mb-1'>Total Wallets</p>
        ...
        <p>If more than one wallet is created the 'nickname' field will be used as a prefix for the new wallets.</p>
      </div>
