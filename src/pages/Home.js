  ...
  return (
    <div className='home'>
      <div className='flex flex-col justify-center items-center'>
        ...
        <Typography variant="h3" gutterBottom component="div">Verifying ownership of</Typography>
        ...
        <Typography variant="body1" gutterBottom component="div">You will recieve access once verified</Typography>
      </div>
    </div>
  )
}
