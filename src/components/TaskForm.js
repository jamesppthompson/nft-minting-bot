      ...
      <div className="task-form">
        <div className='grid grid-cols-2 gap-8'>
          ...
          <div className='col-start-1 col-end-3'>
            <p className='font-bold	mb-1'>Mint Function</p>
          ...
          <div>
            <p className='font-bold	mb-1'>Max Fee Per Gas</p>
            ...
            <p className='font-medium mb-1'>Fee per gas data returned by ether.js</p>
          </div>
          <div>
            <p className='font-bold	mb-1'>Max Priority Fee Per Gas</p>
        ...
        <p className='task-desc'>Gas fees change every block, if you leave these values empty the bot will use the recommended gas settings at the time of mint.</p>
        <Typography variant="body2" gutterBottom component="div" mb={1}>Select one or more wallets for this task</Typography>
